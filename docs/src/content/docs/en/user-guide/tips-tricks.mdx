...
As of `v0.9.0`, there is limited support for complex scheduling of maintenance events. If you have requests for extended functionality in this fork, please [open an issue on GitHub](https://github.com/nstefanelli/homebox/issues) or reach out on Discord. We're still gauging the demand for this feature.
