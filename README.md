...
This is a personal fork ([nstefanelli/homebox](https://github.com/nstefanelli/homebox)) of [sysadminsmedia/homebox](https://github.com/sysadminsmedia/homebox) v0.26.2, adding three feature sets on top of upstream:
